...
/**
 * Handles the creation for table `tables_rbac`.
 */
class m160608_121803_create_tables_rbac extends Migration
{
    /**
    ...
    protected function getAuthManager()
    {
        ...
        $authManager->assignmentTable = '{{%auth_assignment}}';
        $authManager->itemChildTable = '{{%auth_item_child}}';
        $authManager->itemTable = '{{%auth_item}}';
        $authManager->ruleTable = '{{%auth_rule}}';
